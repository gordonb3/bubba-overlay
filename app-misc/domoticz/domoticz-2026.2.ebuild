...
CTIME="2026-05-31 16:02:53 +0200"
COMMIT="facfb476a"
REVCOUNT="18004"
...
src_prepare() {
	...
	grep -r "#include \"../extern/libwebem" | cut -d: -f1 | uniq | while read file; do sed -e "s/#include \".*\/extern\/libwebem\/include\/\([^\"]*\)\"/#include <\\1>/" -i $file; done
