...
# Note: 1.10 is an unofficial release by the Logitech Media Server community, so we are grabbing 1.01 and patch it to reach 1.10
DIST_VERSION=1.01
inherit perl-module
...
PATCHES=( "${FILESDIR}/1.01_gentoo_fix_compiler_warnings.patch"
	  ...
	  "${FILESDIR}/1.10-r1_perl_5.24_invalid_XS_syntax_fix.patch"	  
)
